...
/* ButtonSnap: read a button, and send snap to the serial port. Display a countdown on an LED strip.
       Author: Kevin Osborn
...
void loop() {
  ...
  if (digitalRead(ButtonPin) == LOW && but_enable)
  {
